	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="logo/logo_meda.jpg" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="logo/logo_meda.jpg" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">
     ...
     if(isset($_SESSION['loginuser'])){
        ...
        ?>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<div class="d-xl-none d-lg-none d-md-none d-sm-inline d-inline searchiconBtn mr-2" name="typeahead">
					<i class="icofont-search"></i>
				</div>
			...
			<div class="col-3 align-items-center">
				...
				<div class="dropdown d-inline-block">
			        ...
			        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				    	...
				    	<li><a class="dropdown-item" href="subcategory.php?sid=<?= $sid   ?>&&cid=<?=$cid?> "><?= $sname; ?></a></li>
				              <?php endforeach; ?>
